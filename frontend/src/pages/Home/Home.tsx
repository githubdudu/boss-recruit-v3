  ...
  return (
    ...
    <RootContainer>
      <NavBar
        ...
        className={`relative z-10 rounded-b-lg font-semibold transition-shadow duration-200 ${
      ...
      <div
        className="flex-1 scrollbar-thin scrollbar-thumb-gray-300 overflow-y-auto p-2"
